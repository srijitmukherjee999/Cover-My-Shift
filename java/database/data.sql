...
((SELECT user_id FROM users WHERE username = 'jdoe'), '2024-08-05 08:00:00', 8, 2, FALSE, (SELECT user_id FROM users WHERE username = 'jdoe'), 'Regular shift'),
...
((SELECT shift_id FROM shift WHERE assigned = (SELECT user_id FROM users WHERE username = 'klee')),(SELECT user_id FROM users WHERE username = 'pwhite')),
((SELECT shift_id FROM shift WHERE assigned = (SELECT user_id FROM users WHERE username = 'klee')),(SELECT user_id FROM users WHERE username = 'jdoe'));
